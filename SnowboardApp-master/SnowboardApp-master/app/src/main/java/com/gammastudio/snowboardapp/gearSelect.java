...
public class gearSelect extends AppCompatActivity {
    ...
    public void clickBoard(View view) {
        ...
        LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) bindinglayer.getLayoutParams();
        params.height = 0;
        params.width = LinearLayout.LayoutParams.WRAP_CONTENT;
        bindinglayer.setLayoutParams(params);

        LinearLayout bootlayer = (LinearLayout) findViewById(R.id.bootSelectLayer);
        LinearLayout.LayoutParams params2 = (LinearLayout.LayoutParams) bootlayer.getLayoutParams();
        params2.height = 0;
        params2.width = LinearLayout.LayoutParams.WRAP_CONTENT;
        bootlayer.setLayoutParams(params2);

        LinearLayout helmetlayer = (LinearLayout) findViewById(R.id.helmetSelectLayer);
        LinearLayout.LayoutParams params3 = (LinearLayout.LayoutParams) helmetlayer.getLayoutParams();
        params3.height = 0;
        params3.width = LinearLayout.LayoutParams.WRAP_CONTENT;
        helmetlayer.setLayoutParams(params3);

        LinearLayout gogglelayer = (LinearLayout) findViewById(R.id.goggleSelectLayer);
        LinearLayout.LayoutParams params4 = (LinearLayout.LayoutParams) gogglelayer.getLayoutParams();
        params4.height = 0;
        params4.width = LinearLayout.LayoutParams.WRAP_CONTENT;
        gogglelayer.setLayoutParams(params4);
    }
    ...
    public void clickBinding(View view){
        ...
        LinearLayout snowboardlayer = (LinearLayout) findViewById(R.id.boardSelectLayer);
        LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) snowboardlayer.getLayoutParams();
        params.height = 0;
        params.width = LinearLayout.LayoutParams.WRAP_CONTENT;
        snowboardlayer.setLayoutParams(params);
    ...
    public void clickBoot(View view){
        ...
        LinearLayout.LayoutParams params2 = (LinearLayout.LayoutParams) snowboardlayer.getLayoutParams();
        params2.height = 0;
        params2.width = LinearLayout.LayoutParams.WRAP_CONTENT;
        snowboardlayer.setLayoutParams(params2);
    ...
    public void clickHelmet(View view){
        ...
        LinearLayout.LayoutParams params3 = (LinearLayout.LayoutParams) snowboardlayer.getLayoutParams();
        params3.height = 0;
        params3.width = LinearLayout.LayoutParams.WRAP_CONTENT;
        snowboardlayer.setLayoutParams(params3);
    ...
    public void clickGoggle(View view){
        ...
        LinearLayout.LayoutParams params4 = (LinearLayout.LayoutParams) snowboardlayer.getLayoutParams();
        params4.height = 0;
        params4.width = LinearLayout.LayoutParams.WRAP_CONTENT;
        snowboardlayer.setLayoutParams(params4);
    }
